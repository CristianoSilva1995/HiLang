...
import View.StudentProgressView;
...
public class StudentProgressController {
    ...
    private StudentProgressView view;
    private StudentProgress model;
    ...
    public StudentProgressController(StudentProgressView view, StudentProgress model, AppController appController) {
        this.view = view;
        this.model = model;
    ...
    public void initView() {
        ...
        view.setTitle(config.getProperty("pages.StudentProgress.title"));
        setViewSize();
