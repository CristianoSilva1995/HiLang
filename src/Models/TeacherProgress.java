...
public class TeacherProgress {
    ...
    public TeacherProgress(String contextName, String subContextName, String difficulty, Boolean completed, Integer timesCompleted) {
    ...
    public List<SubContext> getSubContext(Integer idUser){
        TeacherProgressDAO teacherProgressDAO= new TeacherProgressDAO(db);
    ...
    //retrieves the number of subtopics completed by the user
    //calls method on subContextDAO
